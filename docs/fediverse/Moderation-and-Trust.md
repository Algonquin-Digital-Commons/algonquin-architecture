...
Specify Moderation and Trust within the Federated Post-Secondary Digital Commons. This outline inherits the
...
- In scope: requirements, interfaces, dependencies, data, security, operations,
  validation, and roadmap decisions for Moderation and Trust.
...
- Federation uses ActivityPub and related web standards; adopted products stay upstream-compatible.
- Institution-specific value belongs in deployment overlays; shared identity integration, moderation, media, spatial support, policy, and coherent user experience remain portable.
- Evaluate established policy engines and languages before designing custom policy syntax.
- Any exception follows the adopt → extend → compatible fork → build hierarchy and requires an ADR with evidence.
- Local moderation always governs inbound discovery and outbound publication. Remote trust never creates local identity or authority; automated AI signals cannot make final punitive decisions.
- Peer actions include allow, limit/silence, quarantine, actor suspension and domain block, with emergency response, evidence, appeal and review.
...
- [Federated Social Governance Policy](Federated-Social-Governance-Policy.md)
