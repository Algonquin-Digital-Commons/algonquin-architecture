...
Specify Cloud Burst Failover within the Federated Post-Secondary Digital Commons. This outline inherits the
...
- In scope: requirements, interfaces, dependencies, data, security, operations,
  validation, and roadmap decisions for Cloud Burst Failover.
...
- Reliability is designed at versioned service boundaries so an implementation can fail over or be replaced without client redesign.
- Recovery mechanisms use the native, tested capabilities of adopted systems before custom coordination is added.
