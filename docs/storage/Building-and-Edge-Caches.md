...
Specify Building and Edge Caches within the Federated Post-Secondary Digital Commons. This outline inherits the
...
- In scope: requirements, interfaces, dependencies, data, security, operations,
  validation, and roadmap decisions for Building and Edge Caches.
...
- Object access is S3-compatible where appropriate, with content-addressed concepts used for immutable large artifacts.
- Storage products remain replaceable and no proprietary model-distribution or object protocol is introduced.
- Use S3-compatible object access and content-addressed integrity concepts where appropriate.
