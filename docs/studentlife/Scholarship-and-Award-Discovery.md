# Scholarship and Award Discovery
...
Specify Scholarship and Award Discovery within the Federated Post-Secondary Digital Commons. This outline inherits the
...
- In scope: requirements, interfaces, dependencies, data, security, operations,
  validation, and roadmap decisions for Scholarship and Award Discovery.
...
- Student-life features are institution-specific value built on shared identity, policy, events, clients, and standard integration mechanisms.
- Agents plan and request actions; deterministic services enforce authorization, confirmation, execution, verification, and receipts.
