...
Specify Spatial Media Compatibility within the Federated Post-Secondary Digital Commons. This outline inherits the
...
- In scope: requirements, interfaces, dependencies, data, security, operations,
  validation, and roadmap decisions for Spatial Media Compatibility.
...
- Testing includes conformance to selected standards, compatibility with upstream releases, and adapter contract tests.
- Custom extensions require regression tests proving that portable clients and replacement implementations still work.
