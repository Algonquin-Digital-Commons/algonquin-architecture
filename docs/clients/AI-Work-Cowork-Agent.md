...
Specify AI Work Cowork Agent within the Federated Post-Secondary Digital Commons. This outline inherits the
...
- In scope: requirements, interfaces, dependencies, data, security, operations,
  validation, and roadmap decisions for AI Work Cowork Agent.
...
- The Work/Cowork experience is implemented through the OpenWork-derived desktop client, Commons Session Host, Agent Session Contract, and gateway. OpenWork Den and hosted control planes are excluded.
