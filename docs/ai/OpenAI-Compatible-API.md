...
Specify OpenAI Compatible API within the Federated Post-Secondary Digital Commons. This outline inherits the
...
- In scope: requirements, interfaces, dependencies, data, security, operations,
  validation, and roadmap decisions for OpenAI Compatible API.
...
- Conform to ADR-0003: preserve OpenAI-compatible client behavior while keeping native Commons capabilities separate.
