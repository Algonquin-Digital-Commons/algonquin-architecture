# Distributed Inference Backend Interface
...
Specify Distributed Inference Backend Interface within the Federated Post-Secondary Digital Commons. This outline inherits the
...
- In scope: requirements, interfaces, dependencies, data, security, operations,
  validation, and roadmap decisions for Distributed Inference Backend Interface.
...
- Conform to ADR-0004: treat the named engine as an adapter or reference, not as the ACF contract itself.
