# Idle and Interactive User Policy
...
Specify Idle and Interactive User Policy within the Federated Post-Secondary Digital Commons. This outline inherits the
...
- In scope: requirements, interfaces, dependencies, data, security, operations,
  validation, and roadmap decisions for Idle and Interactive User Policy.
