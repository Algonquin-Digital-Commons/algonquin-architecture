# ACF Compute Fabric Architecture

> Status: Accepted baseline; census and implementation incomplete  
> Domain: vision  
> Owner: ACF architecture  
...
- ADR-0004: ACF Runtime Adapter Architecture
...
- Accepted baseline: Census precedes capacity claims; student/interactive use has
  priority; runtimes remain adapters; federation is explicit and bounded.
- Remaining work: Measure hardware, power, network and utilization; select worker
  implementation details; prove isolation, preemption, recovery and accounting.

## References

- [Federated Post-Secondary Digital Commons Architecture](Post-Secondary-Digital-Commons-Architecture.md)
