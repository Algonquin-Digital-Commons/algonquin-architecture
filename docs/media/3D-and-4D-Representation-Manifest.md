# 3D and 4D Representation Manifest
...
Specify 3D and 4D Representation Manifest within the Federated Post-Secondary Digital Commons. This outline inherits the
...
- In scope: requirements, interfaces, dependencies, data, security, operations,
  validation, and roadmap decisions for 3D and 4D Representation Manifest.
