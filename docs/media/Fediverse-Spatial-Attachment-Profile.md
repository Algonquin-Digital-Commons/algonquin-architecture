# Fediverse Spatial Attachment Profile
...
Specify Fediverse Spatial Attachment Profile within the Federated Post-Secondary Digital Commons. This outline inherits the
...
- In scope: requirements, interfaces, dependencies, data, security, operations,
  validation, and roadmap decisions for Fediverse Spatial Attachment Profile.
