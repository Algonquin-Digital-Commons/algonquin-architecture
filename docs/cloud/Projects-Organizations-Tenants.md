# Projects Organizations Tenants
...
Specify Projects Organizations Tenants within the Federated Post-Secondary Digital Commons. This outline inherits the
...
- In scope: requirements, interfaces, dependencies, data, security, operations,
  validation, and roadmap decisions for Projects Organizations Tenants.
